...
public class PredictionCamActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodDB.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(foodLabel != null){
                    Ingredients ingredients = dataSnapshot.child(foodLabel).getValue(Ingredients.class);
                    ing = ingredients.getIngredients();
                }
    ...
    private void runModelInference() {
        ...
        // Create input data.
        ByteBuffer imgData = convertBitmapToByteBuffer(imageCam, imageCam.getWidth(),
                imageCam.getHeight());
    ...
    public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
        ...
        switch (position) {
            case 0:
                mSelectedImage = getBitmapFromAsset(this, "img11.jpg");
                break;
            case 1:
                // Whatever you want to happen when the thrid item gets selected
                mSelectedImage = getBitmapFromAsset(this, "img12.jpg");
                break;
            case 2:
                // Whatever you want to happen when the thrid item gets selected
                mSelectedImage = getBitmapFromAsset(this, "img13.jpg");
                break;
            case 3:
                // Whatever you want to happen when the thrid item gets selected
                mSelectedImage = getBitmapFromAsset(this, "img14.jpg");
                break;
            case 4:
                // Whatever you want to happen when the thrid item gets selected
                mSelectedImage = getBitmapFromAsset(this, "img15.jpg");
                break;
        }
