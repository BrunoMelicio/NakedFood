...
public class IngredientsCamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingredients_cam);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(IngredientsCamActivity.this, HomeActivity.class));
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(IngredientsCamActivity.this, "SAVED!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        if(ing.size() > 0){
            adapt = new ArrayAdapter<String>(IngredientsCamActivity.this,
